...
abstract class BaseServiceIntegrationTest extends BaseIntegrationTest_Pg16 {
    @Autowired
    ...
    /**
     * Overriding child classes methods must be annotation with @{@link BeforeEach} to kick in.
     */
    @BeforeEach
    void init() {
        cleanup();
